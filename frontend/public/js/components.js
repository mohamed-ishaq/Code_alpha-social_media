    ...
    if (user) {
      ...
      content.innerHTML = `
        ...
        <nav class="sidebar-nav">
          ...
          <a class="sidebar-nav-item ${activePage === 'compose' ? 'active' : ''}" href="/compose" data-link>
          ...
          <a class="sidebar-nav-item ${activePage === 'notifications' ? 'active' : ''}" href="/notifications" data-link>
          ...
          <a class="sidebar-nav-item ${activePage === 'messages' ? 'active' : ''}" href="/messages" data-link>
